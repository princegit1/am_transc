...
<tr valign="middle">
<td align="center">
<FORM  method=post name="newsForm" action="news_for_rss_imi.jsp">
<select name="section">
<option value="" selected="selected">Select Section	</option>

<%	
try{
	String selectQuery="SELECT CATEGORY_ID,CATEGORY_TYPE from category_master where SERVICE_PROVIDER='IMI' AND STATUS='ACTIVE'";
