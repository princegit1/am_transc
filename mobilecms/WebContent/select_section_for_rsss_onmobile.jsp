...
<tr valign="middle">
<td align="center">
<FORM  method=post name="newsForm" action="news_for_rss_onmobile.jsp">
<select name="section">
<option value="" selected="selected">Select Section	</option>

<%	
try{
	String selectQuery="SELECT CATEGORY_ID,CATEGORY_TYPE from category_master where SERVICE_PROVIDER='ONMOBILE-RSS' AND STATUS='ACTIVE'";
