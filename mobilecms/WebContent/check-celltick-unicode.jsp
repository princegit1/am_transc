...
<form action="insertcelltick-unicode.jsp" method="post" name="myNews">
...
<tr valign="middle" bgcolor="#dcdcdc" height="50">
			<td colspan="6" align="center">
			 <h2><font color="red">Insert CellTick Data</font></h2>
			 		</td>
		</tr>
...
characters left</td>
				...
				<tr>
					<td>
					 ...
					 <td width="397" valign="top"><textarea name="fulltext"   cols="80" rows="4" onKeyDown="textCounter(document.myNews.fulltext,document.myNews.remLen3,300)"
onKeyUp="textCounter(document.myNews.fulltext,document.myNews.remLen3,300)" style="width:450px;"  ><%=fulltext%></textarea></td>
  <td><input readonly type="text" name="remLen3" size="3" maxlength="3" value="300">
characters left</td>
				</tr>
