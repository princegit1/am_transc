...
try{
				...
				String upQuery="select count(*) count from national_news where date(run_date)=curdate() and category_id=265";
				...
				{
					String sql="UPDATE national_news set headline_1=? , more_1=? ,headline_2=? , more_2=? ,headline_3=? , more_3=? , emp_id=? , update_date=now()  where run_date=? and category_id=265";
					PreparedStatement pstmt = cn.prepareStatement(sql);
