...
try
		...
		upQuery="SELECT headline_1,more_1,headline_2,more_2,headline_3,more_3,update_date as date FROM national_news where date(run_date)=curDate() and category_id=98";
