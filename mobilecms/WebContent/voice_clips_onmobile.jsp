...
String sectionname="";
String pathname="";
String sectionnameurl="";


if(sectionId.equals("259")){
sectionname="voice-clips-onmobile-mp";
pathname="mp";
sectionnameurl="regional-mp";
}
if(sectionId.equals("260")){
sectionname="voice-clips-onmobile-cg";
pathname="chhattisgarh";
sectionnameurl="regional-cg";
}
...
<form action="save_voice_clips_onmobile.jsp"     method="post" name="myNews" onSubmit="return checks();">
<%
ResultSet rs=null;
ResultSet rs1=null;
Connection cn=null;
...
{	
	...
	upQuery1="select e.FNAME as name,nn.msg_id,nn.update_date as date,nn.headline_1,nn.more_1,nn.pic_1,nn.run_date from mobile_rss_news nn,employee e  where nn.msg_id=(select max(msg_id) from mobile_rss_news where category_id='"+sectionId+"') and nn.category_id='"+sectionId+"' and nn.emp_id=e.EMP_ID";
...
<tr valign="middle" bgcolor="#dcdcdc" height="50">
			<td colspan="3" align="center">
			  <P class="topic">Voice clip xml Update:-<%=sectionname%><BR>
			  <a href="sp/regional_voicealerts.jsp?category=<%=sectionnameurl %>" target="_blank">Check Existing</a></P>
			</td>
		</tr>
...
<td>
		<TABLE border="1" cellPadding=3 cellSpacing=1 width="100%">
		  ...
		  <tr> 
			<TD><B>Voice Clip Url</B> :</TD>
			<TD > 
			 http://media1.intoday.in/mobile/regional/<%=pathname %>/<INPUT maxLength=310 size=28 name="hdln1" value="<%=imageStatus1%>" id="eBann-1-1" onKeyUp="Contar('eBann-1-1','sBann-1-1',' {CHAR} characters left.',500);"><span id="sBann-1-1" class="minitext">&nbsp;500 characters left.</span> <span><script></script></span>
		...
		<tr>  <td>&nbsp;</td>
<td colspan="2">
	Voice Clip URL : http://media1.intoday.in/mobile/regional/<%=pathname %>/<%=imageStatus1%><br><br>
