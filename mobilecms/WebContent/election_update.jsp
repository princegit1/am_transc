...
<form action="save_election_news.jsp" method="post" name="myNews" onSubmit="return checks();">
<%
ResultSet rs=null;
ResultSet rs1=null;
Connection cn=null;
...
{	
	...
	upQuery="select e.FNAME as name,nn.msg_id,nn.update_date as date,nn.headline_1,nn.more_1,nn.headline_2,nn.more_2,nn.headline_3,nn.more_3, nn.run_date from national_news nn,employee e where date(nn.run_date)=curDate() and nn.category_id=98 and nn.emp_id=e.EMP_ID";
	upQuery1="select e.FNAME as name,nn.msg_id,nn.update_date as date,nn.headline_1,nn.more_1,nn.headline_2,nn.more_2,nn.headline_3,nn.more_3, nn.run_date from national_news nn,employee e  where nn.msg_id=(select max(msg_id) from national_news where category_id='98') and nn.category_id=98 and nn.emp_id=e.EMP_ID";
...
<tr valign="middle" bgcolor="#dcdcdc" height="50">
			<td colspan="3" align="center">
			  ...
			  <a href="sp/election_news.jsp" target="_blank">Check Existing</a></P>
			</td>
		</tr>
...
<td colspan="2">
	...
	Total Character Kicker1: <%=rs1.getString("more_2").length()%>
</td>
