...
if(errodecode==1)
response.sendRedirect("videos_for_astro_percep.jsp?section="+section+"&msg=Data Insertion Failed..");
else
response.sendRedirect("videos_for_astro_percep.jsp?section="+section+"&msg=Data Insertion Successfull..");
