...
<form action="newsContent.jsp" name="myNews" onSubmit="return checkEmpty()" method="post">
	<table align="center" border="0" cellPadding=0 cellSpacing=0 width="100%">
		...
		<tr valign="middle" bgcolor="#dcdcdc" height="20">
			<td colspan="6" align="right">By: <b><%=name%></b>&nbsp;(<%=date%>)&nbsp;</td>
		</tr>
		<tr height="5">
			<td>
			</td>
			...
			<td>
					<TABLE border="1" cellPadding=3 cellSpacing=1 width="100%">
					  ...
					  <tr> 
						...
						<TD colspan="2">
							<textarea name="N1<%=cCodeArr[i]%>" cols="60" rows="5" ><%=ab.substring(ab.indexOf(tempStr)+tempStr.length(), ab.length())%></textarea>
						</TD>
					  </TR>
					  <tr> 
						<TD>Circle :</TD>                        
