...
String sectionname="";
if(sectionId.equals("160")){
sectionname="national-india";
}
if(sectionId.equals("161")){
sectionname="national-china";
}
if(sectionId.equals("162")){
sectionname="national-philippines";
}
if(sectionId.equals("163")){
sectionname="national-latinamerica";
}
if(sectionId.equals("164")){sectionname="national-caribbean";}
if(sectionId.equals("165")){sectionname="national-middleeast";} 
if(sectionId.equals("166")){sectionname="regional-india";}
if(sectionId.equals("167")){sectionname="business-india";}
if(sectionId.equals("168")){sectionname="business-china";}
if(sectionId.equals("169")){sectionname="business-philippines";}
if(sectionId.equals("170")){sectionname="business-latinamerica";}
if(sectionId.equals("171")){sectionname="business-caribbean";}
if(sectionId.equals("172")){sectionname="business-middleeast";}
if(sectionId.equals("173")){sectionname="sports-india";}
if(sectionId.equals("174")){sectionname="sports-china";}
if(sectionId.equals("175")){sectionname="sports-philippines";}
if(sectionId.equals("176")){sectionname="sports-latinamerica";}
if(sectionId.equals("177")){sectionname="sports-caribbean";}
if(sectionId.equals("178")){sectionname="sports-middleeast";}
if(sectionId.equals("179")){sectionname="entertainment";}
...
<form action="save_rss_news_rogerscanada.jsp"     enctype="multipart/form-data" method="post" name="myNews" onSubmit="return checks();">
<%
ResultSet rs=null;
ResultSet rs1=null;
Connection cn=null;
