...
String sectionname="";
if(sectionId.equals("362")){
sectionname="movies-updates-latest-release";
}
if(sectionId.equals("363")){
sectionname="movies-updates-review";
}
if(sectionId.equals("364")){
sectionname="movies-updates-upcoming-movies";
}
if(sectionId.equals("365")){
sectionname="movies-updates-mvie-star-trivia-suggestion";
}
if(sectionId.equals("366")){
sectionname="star-dust-latest-gossip";
}
if(sectionId.equals("367")){
sectionname="star-dust-stars-biography";
}
if(sectionId.equals("368")){
sectionname="star-dust-stars-latest-news";
}
if(sectionId.equals("369")){
sectionname="food-recipe";
}
if(sectionId.equals("370")){
sectionname="food-food-tip";
}
if(sectionId.equals("371")){
sectionname="food-health-food";
}
if(sectionId.equals("372")){
sectionname="fashion-fashion-tips";
}
if(sectionId.equals("373")){
sectionname="cars-review";
}
if(sectionId.equals("374")){
sectionname="cars-latest-cars";
}
if(sectionId.equals("375")){
sectionname="cars-stars-favorite-buddy";
}
if(sectionId.equals("376")){
sectionname="cars-concept";
}
if(sectionId.equals("377")){
sectionname="magazines-cosmplitan";
}
...
<form action="save_rss_news_imi.jsp"     enctype="multipart/form-data" method="post" name="myNews" onSubmit="return checks();">
<%
ResultSet rs=null;
ResultSet rs1=null;
Connection cn=null;
...
<tr valign="middle" bgcolor="#dcdcdc" height="50">
			<td colspan="3" align="center">
			  ...
			  <a href="sp/imi_news_rss.jsp?category=<%=sectionname %>" target="_blank">Check Existing</a></P>
			</td>
		</tr>
...
<td>
		<TABLE border="1" cellPadding=3 cellSpacing=1 width="100%">
		  ...
		  <tr> 
			<TD><B>Kicker1</B>:</TD>
			<TD colspan="2">
				<textarea cols="60" rows="5" name="kkr1" id="xBann-1-1" onKeyUp="Contar('xBann-1-1','yBann-1-1',' {CHAR} characters left.',500);"><%=more_1%></textarea><span id="yBann-1-1" class="minitext">&nbsp;500 characters left.</span>
			</TD>
		  </TR>
		  <tr> 
