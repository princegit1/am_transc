...
String sectionId="488";
String sectionname="";
if(sectionId.equals("488")){
sectionname="astro-vuclip";}
...
<form action="save_videos_for_astro_vuclip.jsp"     enctype="multipart/form-data" method="post" name="myNews" onSubmit="return checks();">
<%
ResultSet rs=null;
ResultSet rs1=null;
Connection cn=null;
...
<td>
		<TABLE border="0" cellPadding=3 cellSpacing=1 width="70%">
		  ...
		  <tr> 
			<TD>Duration:</TD>
			<TD colspan="2">
			<INPUT maxLength=20 size=20 name="dur1" value="<%=dur_1%>" >
...
<td>
		<TABLE border="0" cellPadding=3 cellSpacing=1 width="70%">
		  ...
		  <tr> 
			<TD>Duration:</TD>
			<TD colspan="2">
			<INPUT maxLength=20 size=20 name="dur2" value="<%=dur_2%>" >
...
<td>
		<TABLE border="0" cellPadding=3 cellSpacing=1 width="70%">
		  ...
		  <tr> 
			<TD>Duration:</TD>
			<TD colspan="2">
			<INPUT maxLength=20 size=20 name="dur3" value="<%=dur_3%>" >
...
<td>
		<TABLE border="0" cellPadding=3 cellSpacing=1 width="70%">
		  ...
		  <tr> 
			<TD>Duration:</TD>
			<TD colspan="2">
			<INPUT maxLength=20 size=20 name="dur4" value="<%=dur_4%>" >
...
<td>
		<TABLE border="0" cellPadding=3 cellSpacing=1 width="70%">
		  ...
		  <tr> 
			<TD>Duration:</TD>
			<TD colspan="2">
			<INPUT maxLength=20 size=20 name="dur5" value="<%=dur_5%>" >
...
<td>
		<TABLE border="0" cellPadding=3 cellSpacing=1 width="70%">
		  ...
		  <tr> 
			<TD>Duration:</TD>
			<TD colspan="2">
			<INPUT maxLength=20 size=20 name="dur6" value="<%=dur_6%>" >
...
<td>
		<TABLE border="0" cellPadding=3 cellSpacing=1 width="70%">
		  ...
		  <tr> 
			<TD>Duration:</TD>
			<TD colspan="2">
			<INPUT maxLength=20 size=20 name="dur7" value="<%=dur_7%>" >
...
<td>
		<TABLE border="0" cellPadding=3 cellSpacing=1 width="70%">
		  ...
		  <tr> 
			<TD>Duration:</TD>
			<TD colspan="2">
			<INPUT maxLength=20 size=20 name="dur8" value="<%=dur_8%>" >
...
<td>
		<TABLE border="0" cellPadding=3 cellSpacing=1 width="70%">
		  ...
		  <tr> 
			<TD>Duration:</TD>
			<TD colspan="2">
			<INPUT maxLength=20 size=20 name="dur9" value="<%=dur_9%>" >
...
<td>
		<TABLE border="0" cellPadding=3 cellSpacing=1 width="70%">
		  ...
		  <tr> 
			<TD>Duration:</TD>
			<TD colspan="2">
			<INPUT maxLength=20 size=20 name="dur10" value="<%=dur_10%>" >
...
<td>
		<TABLE border="0" cellPadding=3 cellSpacing=1 width="70%">
		  ...
		  <tr> 
			<TD>Duration:</TD>
			<TD colspan="2">
			<INPUT maxLength=20 size=20 name="dur11" value="<%=dur_11%>" >
...
<td>
		<TABLE border="0" cellPadding=3 cellSpacing=1 width="70%">
		  ...
		  <tr> 
			<TD>Duration:</TD>
			<TD colspan="2">
			<INPUT maxLength=20 size=20 name="dur12" value="<%=dur_12%>" >
