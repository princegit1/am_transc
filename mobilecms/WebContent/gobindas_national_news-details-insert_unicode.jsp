...
<form action="gobindas_national_news-details-insert-success_unicode.jsp" method="post" name="myNews">
...
<tr valign="middle" bgcolor="#dcdcdc" height="50">
			<td colspan="6" align="center">
			 <h2><font color="red">Insert Cricket Data Details</font></h2>
			  <a href="sp/news-details_gobindas_unicode.jsp" target="_blank">Check Existing</a>
			</td>
		</tr>
