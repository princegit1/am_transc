...
<%	
	...
	for(int k=1;k<=totalMsg;k++)
	{
		...
		*/
			...
			if(rs.next())
			{
				String msg = "<!---horoscope starts--->HOROSCOPE   <!- Aries -> "+rs.getString("message1")+"<!-Aries-end-><!- Taurus -> "+rs.getString("message2")+"<!-Taurus-end-><!- Gemini -> "+rs.getString("message3")+"<!-Gemini-end-><!- Cancer -> "+rs.getString("message4")+"<!-Cancer-end-><!- Leo -> "+rs.getString("message5")+"<!-Leo-end-><!- Virgo -> "+rs.getString("message6")+"<!-Virgo-end-><!- Libra -> "+rs.getString("message7")+"<!-Libra-end-><!- Scorpio -> "+rs.getString("message8")+"<!-Scorpio-end-><!- Sagittarius -> "+rs.getString("message9")+" <!-Sagittarius-end-><!- Capricorn -> "+rs.getString("message10")+"<!-Capricorn-end-><!- Aquarius -> "+rs.getString("message11")+"<!-Aquarius-end-><!- Pisces -> "+rs.getString("message12")+"<!-Pisces-end-><!---horoscope ends--->";
