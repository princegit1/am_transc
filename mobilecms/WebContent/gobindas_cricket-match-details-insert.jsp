...
<form action="gobindas_cricket-match-details-insert-success.jsp" method="post" name="myNews">
...
<tr valign="middle" bgcolor="#dcdcdc" height="50">
			<td colspan="6" align="center">
			 <h2><font color="red">Insert Cricket Data Details</font></h2>
			  <a href="sp/cricket_match_details_gobindas.jsp" target="_blank">Check Existing</a>
			</td>
		</tr>
