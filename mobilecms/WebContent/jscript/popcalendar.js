...
//	email  : pinotoy@yahoo.com
	...
	var imgDir = '/content/img/';		// directory for images ... e.g. var imgDir="/img/"
	var dayName = '';
	...
	*/
	...
	function closeCalendar() {
		...
		showDatesInParts(splitVariable);
	}
	...
	function constructCalendar () {
		...
		sHTML = '<table border="0" style="font-family:verdana;font-size:10px;Z-INDEX:+9999;"><tr>';
	...
	function showCalendar(ctl, ctl2, format, lang, past, fx, fy) 
	{
		...
		if (showToday == 1) {
			document.getElementById('lblToday').innerHTML = '<font color="#000066">' + todayString[language] + ' <a onmousemove="window.status=\''+gotoString[language]+'\'" onmouseout="window.status=\'\'" title="'+gotoString[language]+'" style="'+styleAnchor1+'" href="javascript:monthSelected=monthNow;yearSelected=yearNow;constructCalendar();">'+dayName[language][(today.getDay()-startAt==-1)?6:(today.getDay()-startAt)]+', ' + dateNow + ' ' + monthName[language][monthNow].substring(0,3) + ' ' + yearNow + '</a></font>';
		}
