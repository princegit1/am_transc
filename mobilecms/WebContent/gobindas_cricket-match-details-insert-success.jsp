...
<%
    			...
    			try
                	...
                	String sqlinsert="INSERT INTO iplscore_details (smstype,smstext,RECORD_DATE,UPDATE_EMP_ID,type ) VALUES ('"+type+"','"+text+"',now(),'"+empId+"','gobindas')";
...
<%
		...
		response.sendRedirect("gobindas_cricket-match-details-insert.jsp?msg="+msg);
    %>
