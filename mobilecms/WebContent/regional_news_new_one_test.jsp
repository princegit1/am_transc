...
String[] cCodeArr = { "BHR","DEL","HRY","HP","JK","MP","PUN","UPW","WB"};
String[] cNameArr = {"BIHAR","DELHI","HARYANA", "HP", "JammuKashmir","MP","PUNJAB","UP","WESTBENGAL"};
%>
<html>
<head>
	...
	<table align="center" border="0" cellPadding=0 cellSpacing=0 width="100%">
		...
		<tr valign="middle" bgcolor="#dcdcdc" height="50">
			<td colspan="6" align="center">
			  ...
			  <a href="sp/news_new_one.html" target="_blank">Check Existing</a>
