...
function resetTextAreas()
{
				...
				document.myNews.text.value = "";
					document.myNews.team1.value = "";
					document.myNews.team2.value = "";
...
<%
	...
	try
	{
		...
		{		MSG_ID=rs.getString("MSG_ID");
				...
				eventValue1="selected=\"selected\"";
				} if(type.equals("PRE_MATCH_ANALYSIS_EVENT")){
				eventValue2="selected=\"selected\"";
				} if(type.equals("TOSS_EVENT")){
				eventValue3="selected=\"selected\"";
				} if(type.equals("BREAK_EVENT")){
				eventValue4="selected=\"selected\"";
				} if(type.equals("END_OF_MATCH_EVENT")){
				eventValue5="selected=\"selected\"";
				} if(type.equals("SCHEDULE")){
				eventValue6="selected=\"selected\"";
				}
...
<form action="cricket-match-details-insert-success.jsp" method="post" name="myNews">
...
<tr valign="middle" bgcolor="#dcdcdc" height="50">
			<td colspan="6" align="center">
			 <h2><font color="red">Insert Cricket Data Details</font></h2>
			  <a href="sp/cricket_match_details.jsp" target="_blank">Check Existing</a>
			</td>
		</tr>
				...
				<tr>
					...
					<td>
						Type 
							 ...
							 <td width="397" valign="top"><select name="series">
							
<option value="MAN_OF_MATCH_EVENT" <%=eventValue1 %>>Man of match</option>	
<option value="PRE_MATCH_ANALYSIS_EVENT" <%=eventValue2%>>Build up - pre match</option>		
<option value="TOSS_EVENT" <%=eventValue3 %>>Toss</option>		
<option value="BREAK_EVENT" <%=eventValue4 %>>Break</option>		
<option value="END_OF_MATCH_EVENT" <%=eventValue5 %>>End of match</option>	
<option value="SCHEDULE" <%=eventValue6 %>>Schedule</option>
...
characters left</td>
				...
				<tr>
					<td>
					 ...
					 <td width="397" valign="top"><input type="text" name="team1" value="<%=team1%>"></td>
				...
				<tr>
					<td>
					 ...
					 <td width="397" valign="top"><input type="text" name="team2" value="<%=team2%>"></td>
