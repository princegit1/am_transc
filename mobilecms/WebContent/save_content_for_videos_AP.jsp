...
<%
	...
	cn = adminConn.getConnection();
					...
					//	String sql="INSERT INTO mobile_rss_news (category_id,more_1,pic_1,pic_2,run_date,update_date,emp_id,headline_1) VALUES (?,?,?,?,?,?,?,?)";
						String sql="UPDATE mobile_rss_news set pic_1=? where category_id=? AND more_1=?";
	...
	{
	e.printStackTrace();
	response.sendRedirect("news_for_videos_AP.jsp?msg=Data Insertion Failed..");
	}
finally
{
	if(pstmt!=null)
...
response.sendRedirect("select_section_for_videos_AP.jsp?msg=Data updated Successfull..");
	%>
