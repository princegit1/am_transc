...
try
{				
	upQuery="SELECT headline_1,headline_2,headline_3,date_format(update_date,'%d%m%Y')record_date,time_format(update_date,'%r ')record_time FROM national_news where date(run_date)=curDate() and category_id=265";
