...
<%
	...
	AdminConn adminConn = AdminConn.getInstance();
		...
		try
		{	
				astroQuery="SELECT message1,message2,message3,message4,message5,message6,message7,message8,message9,message10,message11,message12,date_format(run_date,'%d%m%Y')currentdate FROM message_details where category_id=16 and DATE_FORMAT(run_date, '%d%m%Y')='"+alertDate+"'";
