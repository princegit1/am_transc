<%@ page import="java.sql.*,java.io.*,conn.*,com.itgd.server.DecodeXML"%><%String keyword = "";keyword = request.getParameter("keyword");
				
			String completeNews = "", newsOne = "", newsTwo = "", newsThree = "";
			String[] cCodeArr = {  "TN","AP","GUJ", "MUM","MP","PUN","HRY","HP","UPE", "UPW","KER" };
			String[] cNameArr = { "TN","AP","GUJ","MUM","MP","PUN","HRY","HP","UPE", "UPW","KER"};
			Connection cn = null;
			ResultSet rs = null;
			Statement stmt = null;
