...
<?xml version="1.0" encoding="UTF-8"?><%@ page import="java.sql.*,conn.*"%><%	
	...
	String category = "onmobile-guwahati";	
...
message="1#BSE-19,831.86(+109.57),NSE-6,025.15(+29.75) at 9:16am.2#India to grow at 6pc this fiscal: S & P.3#Ranbaxy may take a $1bn hit.Source-BT";
	completeNews = replaceSpCharacters(message);	

out.println(completeNews );	
