			...
			if (category != null || !category.equals("")) {
				for (int i = 0; i < 23; i++) {
					...
					if (category.equals(cCodeArr[i])) {
						...
						}out.println(newsOne+"<BR>"+newsTwo+"<BR>"+newsThree);}}}}}catch (Exception e){e.printStackTrace();out.println("Connectivity is not available at this moment");}finally{try {if (rs != null)rs.close();if (stmt != null)stmt.close();if (cn != null)cn.close();}catch(SQLException e){e.printStackTrace();}}}%>