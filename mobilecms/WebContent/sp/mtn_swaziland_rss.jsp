...
cn = adminConn.getConnection();
		...
		lastbuildDate=rs.getString("run_date");
		 if(category.equals("swaziland-local-news") || category.equals("swaziland-international-news") || category.equals("swaziland-business-news") || category.equals("swaziland-sports-news") || category.equals("swaziland-weather-news") )
			{
			%>
