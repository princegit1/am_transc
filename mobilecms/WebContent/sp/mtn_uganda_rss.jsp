...
cn = adminConn.getConnection();
		...
		lastbuildDate=rs.getString("run_date");
		 if(category.equals("uganda-general-local-news") || category.equals("uganda-local-business-news") || category.equals("uganda-political-news") || category.equals("uganda-local-sports-news") || category.equals("uganda-local-weather-news") || category.equals("uganda-international-business-news") || category.equals("uganda-international-political-news") || category.equals("uganda-generic-international-news"))
			{
			%>			
