...
<tr valign="middle">
<td align="center">
<FORM  method=post name="newsForm" action="news_for_olympic2012.jsp">
<select name="section">
<option value="" selected="selected">Select Section	</option>

<%	
try{
	String selectQuery="select category_id,category_type from category_master where service_provider='itgd' and category_id between 396 and 405 and status='active'";
