...
<%
	...
	Statement stmt = null;
	String fileName="63";
	String xmlPath="/home/jboss-4.2.2.GA/server/default/deploy/smscms.war/xml/";
...
try{
				...
				String upQuery="select count(*) count from national_news where date(run_date)=curdate() and category_id=63";
				...
				if(count<=0)
				{
					try
					{
						String sql="INSERT INTO national_news (category_id,headline_1,more_1,headline_2,more_2,headline_3,more_3,headline_4,more_4,headline_5,more_5, run_date,update_date,emp_id) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,now(),?)";
				...
				{
					String sql="UPDATE national_news set headline_1=? , more_1=? ,headline_2=? , more_2=? ,headline_3=? , more_3=? , headline_4=? , more_4=? ,headline_5=? , more_5=? , emp_id=? , update_date=now()  where run_date=? and category_id=63";
					PreparedStatement pstmt = cn.prepareStatement(sql);
