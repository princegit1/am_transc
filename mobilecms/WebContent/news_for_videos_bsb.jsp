...
if(sectionId.equals("889")){
sectionname="mrss-video";
}
...
if(sectionId.equals("889")){sectionname="mrss-video";}
%>
<html>
<head>
...
<form action="save_content_for_videos_bsb.jsp"  method="post" name="myNews" onSubmit="return checks();">
<%
ResultSet rs=null;
ResultSet rs1=null;
Connection cn=null;
...
{	
	...
	upQuery1="select e.FNAME as name,nn.msg_id,nn.update_date as date,nn.headline_1,nn.more_1,nn.pic_1,nn.pic_2,nn.run_date from mobile_rss_news nn,employee e  where nn.msg_id=(select max(msg_id) from mobile_rss_news where category_id='"+sectionId+"') and nn.category_id='"+sectionId+"' and nn.emp_id=e.EMP_ID";
...
<td>
		<TABLE border="1" cellPadding=3 cellSpacing=1 width="100%">
          ...
          <tr> 
			<TD><B>Title</B>:</TD>
			<TD colspan="2">
				 <INPUT maxLength=310 size=30 name="pic1" value="<%=headline_1%>" id="fBann-1-1" onKeyUp="Contar('fBann-1-1','sBann-1-1',' {CHAR} characters left.',30);"><span id="fBann-1-1" class="minitext">&nbsp;20 characters left.</span> <span><script></script></span>
			</TD>
		  </TR>
		  ...
		  <tr> 
			...
			<TD colspan="2">
				<textarea cols="60" rows="5" name="kkr1" id="xBann-1-1" onKeyUp="Contar('xBann-1-1','yBann-1-1',' {CHAR} characters left.',300);"><%=more_1%></textarea><span id="yBann-1-1" class="minitext">&nbsp;150 characters left.</span>
			</TD>
		  </TR>
