...
<%
	...
	{
	e.printStackTrace();
	response.sendRedirect("news_for_rss_imi.jsp?msg=Data Insertion Failed..");
	}
finally
{
	if(pstmt!=null)
...
response.sendRedirect("select_section_for_rsss_imi.jsp?msg=Data Insertion Successfull..");
	%>
