...
<%
	...
	{
%>
		if(document.myNews.N1<%=cCodeArr[i]%>.value.length > 160)
		{
...
<%
	...
	try
	{
		...
		String upQuery1 = "select news_id, news, date_format(a.record_date,'%d-%M-%Y %r ')record_date,fname,lname  from mobile_news_new a, employee b where a.emp_id=b.emp_id and news_id= (select max(news_id) from mobile_news_new)";
		cn = adminConn.getConnection();
...
%>
<form action="newsContent_new.jsp" name="myNews" onSubmit="return checkEmpty()" method="post">
	<table align="center" border="0" cellPadding=0 cellSpacing=0 width="100%">
		...
		<tr valign="middle" bgcolor="#dcdcdc" height="50">
			<td colspan="6" align="center">
			  ...
			  <a href="sp/news_new.html" target="_blank">Check Existing</a>/
			  <a href="news_buongiorno.jsp" target="_blank">Check Buongiorno News</a></P>
			</td>
		</tr>
