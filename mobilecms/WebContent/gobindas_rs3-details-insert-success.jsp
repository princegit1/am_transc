...
<%
    			...
    			try
                	...
                	String sqlinsert="INSERT INTO iplscore_details (smstype,smstext,RECORD_DATE,UPDATE_EMP_ID,type ) VALUES ('"+type+"','"+text+"',now(),'"+empId+"','rs3_news')";
...
<%
		...
		response.sendRedirect("gobindas_rs3-details-insert.jsp?msg="+msg);
    %>
