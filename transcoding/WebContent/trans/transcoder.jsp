<%-- 
    Document   : trancoder
    Created on : Jun 3, 2013, 2:48:24 PM
    Author     : vijayendrar
--%>
...
List<AmazonAwsJobDesc_12> amazonAwsJobDescsList = atdao.listAmazonAwsJobDesc(getProfileIdFromConfiguration());
%>
<html>
    <head>
            ...
            <table>
                <tr>
                    <td>
                        ...
                        <form action="transcoder.jsp" method="post">                            
                            <div style="float: left">Select Job</div>
                            ...
                            <div style="float: left">
                                ...
                                <div style="float: left"> <input type="submit" value="SHOW" style="color: #FFFFFF; background-color: #800000" /> </div>       
                        </form>
                    </td>
                </tr>
...
<%
                                                    ...
                                                    AmazonAwsJobDesc_12 amazonAwsJobDescs = atdao.getAmazonAwsJobDescById(id);
