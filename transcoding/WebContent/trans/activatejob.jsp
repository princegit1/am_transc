<%-- 
    Document   : activatejob
    Created on : Jun 17, 2013, 5:07:38 PM
    Author     : vijayendrar
--%>
            ...
            <table>
                <tr>
                    <td>
                        ...
                        <form action="activatejob.jsp" method="post">                            
                            <div style="float: left">Select job to Activated or De-activate: </div>
